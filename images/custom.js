...
//	};
	...
	$('.tab-but-6').click(function() {
		...
		$('.tab-content').slideUp(200);
		$('.tab-content-6').slideDown(200);	
		return false;	
	});	
	
	$('.tab-but-7').click(function() {
		$('.tab-but').removeClass('tab-active');
		$('.tab-but-7').addClass('tab-active');
		$('.tab-content').slideUp(200);
		$('.tab-content-7').slideDown(200);	
		return false;	
	});	
	...
	$(".next-staff").click(function(){
	  owlStaffControls.trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.next');
	  return false;
	});
	$(".prev-staff").click(function(){
	  owlStaffControls.trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.prev');
	  return false;
	});
	...
	$(".next-quote").click(function() {
	  owlQuoteSlider.trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.next');
	  return false;
	});
	$(".prev-quote").click(function() {
	  owlQuoteSlider.trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.prev');
	  return false;
	});
	...
	function interval() {
		if(isPause === false){
			...
			if(percentTime >= 100){
			  //slide to next item 
			  $elem.trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.next')
			}
		}
	}
	...
	$(".next-home").click(function() {
		$(".homepage-slider").trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.next');
		return false;
	});
	$(".prev-home").click(function() {
		$(".homepage-slider").trigger('http://m.bjsxt.com/statics/images//wap/scripts/owl.prev');
		return false;
	});	
